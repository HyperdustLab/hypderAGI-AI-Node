...
def batch_inference():
    while True:
        ...
        if batch:
            inputs = tokenizer([alpaca_prompt.format('Please generate a motion script according to the following description', text, "") for text in batch], return_tensors="pt").to("cuda")
